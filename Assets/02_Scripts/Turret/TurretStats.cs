...
public class TurretStats
{
    ...
    public static int TURRET1_ATTACK_SPEED => 2;
    public static int TURRET2_ATTACK_SPEED => 5;
    public static int TURRET3_ATTACK_SPEED => 8;

    [Header("Turret Cost")]
    // 포탑의 공격 속도 수치 자체에 대해서는 추가적인 고민이 필요할 거 같습니다.
    // int로 해서 단순히 수치 자체가 1초에 공격하는 횟수로 할 지, 아니면 다른 게임에서처럼 특정 공식을 통해 공격 속도를 산출할지 등등...
    // 같이 생각해보면 좋을 거 같아요! 초반부 설계에서만 봤을 때는, 단순하게 하려면 수치 자체를 1초에 공격하는 횟수로 지정해도 괜찮을 거 같습니다...
    public static int TURRET1_COST => 10;
    public static int TURRET2_COST => 25;
    public static int TURRET3_COST => 50;
}