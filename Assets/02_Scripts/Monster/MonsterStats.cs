...
// 스크립트 상단에 using static MonsterHP; 를 작성하시고 NOMRAL_MONSTER_HP를 마음껏 사용하시면 됩니다.

// 참고로 수치는 진짜 임의대로 아무거나 넣어놓은 것입니다.

public class MonsterHP
{
    public static readonly float NORMAL_MONSTER_HP = 10.0f;
    public static readonly float ELITE_MONSTER_HP = 50.0f;
    public static readonly float BOSS_MONSTER_HP = 200.0f;
}

public class MonsterAttackDamage
{
    public static readonly float NORMAL_MONSTER_ATTACK_DAMAGE = 5.0f;
    public static readonly float ELITE_MONSTER_ATTACK_DAMAGE = 15.0f;
    public static readonly float BOSS_MONSTER_ATTACK_DAMAGE = 30.0f;
}
...
public class MonsterAttackSpeed
{
