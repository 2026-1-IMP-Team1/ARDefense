...
public static class Gold
{
    ...
    public static readonly int NORMAL_MONSTER_GOLD = 2 + PhaseWeight * 2;
    public static readonly int ELITE_MONSTER_GOLD = 8 + PhaseWeight * 4;
    public static readonly int BOSS_MONSTER_GOLD = 20 + PhaseWeight * 5;
